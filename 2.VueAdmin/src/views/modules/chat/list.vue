        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"1px solid #d9d9d9","cursor":"pointer","padding":"0 10px","margin":"0 0px 5px 0","color":"#444","borderRadius":"0px","background":"#fff","width":"auto","fontSize":"13px","minWidth":"40px","height":"26px"}'
                size="small"
